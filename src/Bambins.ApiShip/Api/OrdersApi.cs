...
namespace Bambins.ApiShip.Api
{
    ...
    public class OrdersApi : ApiAccessor
    {
        ...
        public OrdersApi(bool isSandbox = false, Func<ApiShipCredentials> credentialsFactory = null, Func<HttpClient> httpClientFactory = null)
            : base(string.Empty, isSandbox, credentialsFactory, httpClientFactory)
        {
        }

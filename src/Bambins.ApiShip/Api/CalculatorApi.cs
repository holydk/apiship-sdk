...
namespace Bambins.ApiShip.Api
{
    ...
    public class CalculatorApi : ApiAccessor
    {
        ...
        public CalculatorApi(bool isSandbox = false, Func<ApiShipCredentials> credentialsFactory = null, Func<HttpClient> httpClientFactory = null)
            : base("/calculator", isSandbox, credentialsFactory, httpClientFactory)
        {
        }

...
namespace Bambins.ApiShip.Models
{
    ...
    public class CalculatorRequest
    {
        ...
        /// <summary>
        /// Gets or sets the delivery types. If not passed, then tariffs for all types are calculated (Delivery by Courier, Pickup from the pickup point).
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets the pickup types. If not passed, then tariffs for all types are calculated (Cargo collection by courier, Delivery of cargo to the pickup point).
        /// </summary>
